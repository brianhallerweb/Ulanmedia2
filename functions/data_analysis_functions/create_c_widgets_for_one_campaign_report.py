...
def create_c_widgets_for_one_campaign_report(date_range, vol_id, c1_input, c2_input,
        c3_input, c4_input, c5_input, c6_input, c1Value_input, c2Value_input, c3Value_input, c4Value_input, c5Value_input):

    with open(f'{os.environ.get("ULANMEDIAAPP")}/data/c_widgets_for_one_campaign/{vol_id}_{date_range}_c_widgets_for_one_campaign_dataset.json', 'r') as file:
